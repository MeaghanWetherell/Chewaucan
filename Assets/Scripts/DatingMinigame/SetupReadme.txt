...
2. 
2.1 add a start prefab under the coursemanager at the desired start location. adjust the text on the sign as desired. 
2.2 Add a DatingHelpInteractable prefab in front to allow the user to access the help menu. 
2.3 add an empty object representing the position the player should be reset to on death and assign it to the start position
field of the coursemanager
