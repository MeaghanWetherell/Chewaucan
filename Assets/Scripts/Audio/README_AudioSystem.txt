...
General Description:
	...
	The core of the sound system is the SoundManager.cs script. This script is a singleton; duplicate instances that are created
...
Troubleshooting:
	Having trouble with your narration sounding fuzzy or odd despite controlling the loudness normalization? This is an issue with the maximum volume as set by the audio mixer.